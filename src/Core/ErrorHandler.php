...
use Eng\Core\Environment;
use Swift_Mailer;

class ErrorHandler
{
    /**
     * @var \Eng\Core\Environment
     */
    protected $env;
    ...
    protected function mailError($type, $message, $file, $line, $trace)
    {
        ...
        $mailMessage = \Swift_Message::newInstance()
            ->setSubject("Error/Exception on English Site - $envName ($host)")
            ->setFrom('bugs@mmyyabb.com')
            ->setTo('sunce.apples@163.com')
            ->setBody($body);
    ...
    protected function printError($type, $message, $file, $line, $trace)
    {
        ...
        $out = '<!doctype html><head><title>English Error</title></head><body>';
        $out .= '<h1>Error</h1>';
